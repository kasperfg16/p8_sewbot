...
env = gym.vector.make("UR5_ddpg_no_noise", num_envs=1, asynchronous=True)
...
experiment_name = cfg_ddpg["experiment"]["experiment_name"] + "_eval_"
...
# load checkpoint
agent_ddpg.load("./runs_for_report/DDPG_env_iteration_3_config_2/checkpoints/best_agent.pt")
